...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="fixed top-4 right-4 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700"
    >
